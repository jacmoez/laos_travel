...
export default function Header({ onBookNow }: HeaderProps) {
  ...
  return (
    <header className="bg-[#2E7D32] text-white sticky top-0 z-50 shadow-md w-full">
        ...
        <div className="flex justify-between items-center h-14">
          <Link href="/" className="flex items-center">
            <span
              ...
              style={{ color: "#FFE0B2", fontFamily: "Georgia, 'Times New Roman', Times, serif" }}
            >
          ...
          <nav className="hidden md:flex items-center">
            <button
              ...
              className="hover:text-[#ED6A02] transition px-3 py-2 text-base cursor-pointer"
            >
              Book Now
            </button>
            {isHomePage && (
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#2E7D32] p-2 shadow-lg border-t border-white/10">
          <button
            onClick={handleBookNow}
            className="block w-full text-left px-4 py-3 text-white hover:bg-[#ED6A02] transition"
          >
            Book Now
          </button>
          {isHomePage && (
            <Link
              href="#our_services"
              className="block px-4 py-3 text-white hover:bg-[#ED6A02] transition"
